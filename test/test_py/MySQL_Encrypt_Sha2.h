...
*/
#ifndef ENCRYPT_SHA256_H
#define ENCRYPT_SHA256_H

#include <inttypes.h>
#include "Print.h"

#define HASH_LENGTH 32       // SHA-256 produces a 32-byte hash
#define BLOCK_LENGTH 64      // SHA-256 uses 64-byte blocks
...
class Encrypt_SHA256 : public Print {
  public:
    void init(void);
