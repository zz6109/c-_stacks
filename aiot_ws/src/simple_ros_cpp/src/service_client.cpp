...
public:
    Service_client()
        ...
        _client = create_client<std_srvs::srv::SetBool>("client");
        ...
        _send_timer = create_wall_timer(3s, std::bind(&Service_client::send_request, this));
        _update_timer = create_wall_timer(100ms, std::bind(&Service_client::update, this));
...
private:
    ...
    void send_request(){
        ...
        auto future = _client->async_send_request(_request,
                                                  std::bind(&Service_client::done_callback,
                                                            this,
                                                            std::placeholders::_1));
    }
